...
return [
    ...
    'home' => [
        ...
        'story_heading' => 'Onde Cada Espaço Conta a Sua História',
        'contact_us' => 'Fale conosco',
        'stat_completed_projects' => 'Projetos Concluídos',
        'stat_team_members' => 'Membros da Equipe',
        'stat_projects_in_progress' => 'Projetos em Andamento',
        'stat_years_experience' => 'Anos de Experiência',
        'portfolio_heading' => 'Portfólio',
        'view_more' => 'Ver mais',
        'pieces_heading' => 'Descubra as Peças Por Trás da Minha Visão',
        'pieces_paragraph' => 'A criatividade é despertada pelos espaços em que vivemos e interagimos — nossas memórias, inspirações e as referências que buscamos nos outros. Encontre sua própria referência comigo e descubra meus projetos de design de móveis e objetos.',
    ...
    'about' => [
        ...
        'hive' => [
            'creative_direction' => [
                ...
                'desc' => 'Larissa lidera pessoalmente o processo criativo — moldando o conceito, interpretando a visão do cliente e guiando cada parceiro rumo a um design coeso.',
            ],
            'technical_drawings' => [
                'label' => 'Desenhos Técnicos',
                'desc' => 'Traduzem cada conceito em desenhos técnicos precisos e documentação pronta para construção.',
            ],
            'finance' => [
                'label' => 'Financeiro',
                'desc' => 'Gerenciam orçamentos e investimentos para que cada projeto siga no caminho certo, com transparência e responsabilidade.',
            ],
            'final_staging' => [
                'label' => 'Ambientação Final',
                'desc' => 'Dão vida ao espaço finalizado com styling, decoração e a camada final de detalhes.',
            ],
            'specifications' => [
                'label' => 'Especificações',
                'desc' => 'Definem materiais, acabamentos e especificações técnicas com precisão e consistência.',
            ],
            'construction_supervision' => [
                'label' => 'Supervisão de Obra',
                'desc' => 'Acompanham cada etapa no canteiro de obras, garantindo que a construção corresponda à intenção do projeto até o último detalhe.',
            ],
            'purchasing_logistics' => [
                'label' => 'Compras & Logística',
                'desc' => 'Buscam, gerenciam e entregam cada material e mobília exatamente onde e quando são necessários.',
            ],
        ],
        'cta_heading' => 'Quer explorar um pouco mais?',
        'cta_paragraph' => 'Agende uma consultoria com nossos especialistas em design e descubra um mundo de possibilidades.',
    ...
    'portfolio' => [
        ...
        'design_insights' => [
            ...
            'quotes' => [
                ...
                'vinculo-lamp' => 'A conexão invisível, porém palpável, onde a luz nos olhos de um ilumina e completa a do outro.',
                'brisa-side-table' => 'A brisa dá leveza ao espaço — formas que flutuam e se sobrepõem, elevando-o.',
            ],
        ],
        'show' => [
            'back_to' => 'Voltar para :label',
            'gallery' => 'Galeria',
            'order_piece' => 'Encomendar Esta Peça',
        ],
        'image_coming_soon' => 'Imagem em Breve',
    ],
